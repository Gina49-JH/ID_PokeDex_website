...
$(document).ready(function () {
  ...
  const APIKEY = "5fbf037e9b05b8befe8eef787293eb1800c9d";
  getContacts();
  ...
  $("#contact-submit").on("click", function (e) {
    ...
    let contactName = $("#form-name").val();
    let contactEmail = $("#form-email").val();
    let contactMessage = $("#form-message").val();
    let contactNumber = $("#form-number").val();
    ...
    let settings = {
      "async": true,
      "crossDomain": true,
      "url": "https://database-e3d2.restdb.io/rest/contact",
    ...
    $.ajax(settings).done(function (response) {
      ...
      $("#add-update-msg").show().fadeOut(500);
  ...
  function updateForm(id, contactName, contactEmail, contactMsg) {
    ...
    var settings = {
      "async": true,
      "crossDomain": true,
      "url": `https://database-e3d2.restdb.io/rest/contact/${id}`,//update based on the ID
      "method": "PUT",
      "headers": {
        "content-type": "application/json",
        "x-apikey": APIKEY,
